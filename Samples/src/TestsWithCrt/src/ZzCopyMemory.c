...
RT_B RT_CALL ZzTestCopyMemory()
{
  ...
  if (!ZzStopChrono(_R("memcpy"), &rtStartCounter)) goto handle_error;
  ...
  if (!ZzStopChrono(_R("memcpy in function"), &rtStartCounter)) goto handle_error;
  ...
  if (!ZzStopChrono(_R("RtCopyMemory"), &rtStartCounter)) goto handle_error;
  ...
  if (!ZzStopChrono(_R("RT_MEMORY_COPY"), &rtStartCounter)) goto handle_error;
