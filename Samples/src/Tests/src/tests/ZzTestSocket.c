...
RT_B RT_CALL ZzTestSockets()
{
  ...
  if (!RtThread_Create(&zzThread, &ZzServerSocketThreadCallback, &zzEvent)) goto handle_error;
  ...
  if (!RtSocket_ConnectWithAddress(&zzSocket, (RT_SOCKET_ADDRESS*)&zzSocketAddress)) goto handle_error;
