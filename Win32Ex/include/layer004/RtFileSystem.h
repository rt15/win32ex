...
/**
 * <p>
 * <tt>lpBuffer</tt> can be equals to <tt>lpPath</tt>.<br>
 * In that case we only cut <tt>lpPath</tt> at the right place efficiently.
 * </p>
 */
 ...
 *
 * <p>
 * lpBuffer can be the same as lpParentPath.
 * </p>
 *
