...
RT_B RT_API RtEncodeToBase64(RT_CHAR8* lpString, RT_CHAR8* lpBuffer, RT_UN unBufferSize, RT_UN* lpWritten)
{
  return RtEncodeToBase64WithSize(lpString, RtGetString8Size(lpString), lpBuffer, unBufferSize, lpWritten);
}


RT_B RT_API RtEncodeToBase64WithSize(RT_CHAR8* lpString, RT_UN unStringSize, RT_CHAR8* lpBuffer, RT_UN unBufferSize, RT_UN* lpWritten)
{
  RT_UCHAR8* lpUString;
  RT_UN32 unNumber;
...
RT_B RT_API RtDecodeFromBase64(RT_CHAR8* lpBase64, RT_CHAR8* lpBuffer, RT_UN unBufferSize, RT_UN* lpWritten)
{
  return RtDecodeFromBase64WithSize(lpBase64, RtGetString8Size(lpBase64), lpBuffer, unBufferSize, lpWritten);
}

RT_B RT_API RtDecodeFromBase64WithSize(RT_CHAR8* lpBase64, RT_UN unBase64Size, RT_CHAR8* lpBuffer, RT_UN unBufferSize, RT_UN* lpWritten)
{
  RT_CHAR8* lpEnd;
  RT_UN32 unBuffer;
  RT_UN unOutputSize;
