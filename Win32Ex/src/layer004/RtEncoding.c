 ...
 */
RT_UN RT_CALL RtEncoding_EncodeOrDecodeUsingWindows(RT_CHAR8* lpInput, RT_UN unInputSize, RT_UN unEncoding, RT_CHAR8* lpBuffer, RT_UN unBufferSize, void** lpHeapBuffer, RT_UN* lpHeapBufferSize, RT_CHAR8** lpOutput, RT_HEAP** lpHeap, RT_B bEncode, RT_UN unOutputTerminatingZeroSize)
{
  UINT nCodePage;
 ...
 */
void RT_CALL RtEncoding_Copy16LeTo32Le(RT_UN16* lpSource, RT_UN32* lpDestination, RT_UN unSize)
{
  RT_UN unI;
 ...
 */
void RT_CALL RtEncoding_Copy16LeTo32Be(RT_UN16* lpSource, RT_UN32* lpDestination, RT_UN unSize)
{
  RT_UN unI;
 ...
 */
void RT_CALL RtEncoding_Copy16BeTo32Le(RT_UN16* lpSource, RT_UN32* lpDestination, RT_UN unSize)
{
  RT_UN unI;
 ...
 */
void RT_CALL RtEncoding_Copy16BeTo32Be(RT_UN16* lpSource, RT_UN32* lpDestination, RT_UN unSize)
{
  RT_UN unI;
 ...
 */
void RT_CALL RtEncoding_Copy32LeTo16Le(RT_UN32* lpSource, RT_UN16* lpDestination, RT_UN unSize)
{
  RT_UN unI;
 ...
 */
void RT_CALL RtEncoding_Copy32LeTo16Be(RT_UN32* lpSource, RT_UN16* lpDestination, RT_UN unSize)
{
  RT_UN unI;
 ...
 * Swap then affectation, "2 1 0 0" -> "1 2".
 */
void RT_CALL RtEncoding_Copy32BeTo16Le(RT_UN32* lpSource, RT_UN16* lpDestination, RT_UN unSize)
{
  RT_UN unI;
 ...
 */
void RT_CALL RtEncoding_Copy32BeTo16Be(RT_UN32* lpSource, RT_UN16* lpDestination, RT_UN unSize)
{
  RT_UN unI;
 ...
 */
RT_UN RT_CALL RtEncoding_EncodeOrDecodeUnicode(RT_CHAR8* lpInput, RT_UN unInputCharSize, RT_UN unInputEncoding, RT_CHAR8* lpBuffer, RT_UN unBufferSize, void** lpHeapBuffer, RT_UN* lpHeapBufferSize, RT_CHAR8** lpOutput, RT_HEAP** lpHeap, RT_UN unOutputEncoding, RT_UN unInputTerminatingZeroSize, RT_UN unOutputTerminatingZeroSize)
{
    ...
    case RT_ENCODING_UTF_16LE:
      switch (unOutputEncoding)
      {
        ...
        case RT_ENCODING_UTF_16BE:
          /* Swap 16. */
          RtMemory_SwapBytes16((RT_UN16*)lpInput, (RT_UN16*)lpOutputPayload, unInputCharSize);
          break;
        case RT_ENCODING_UTF_32:
        case RT_ENCODING_UTF_32LE:
          RtEncoding_Copy16LeTo32Le((RT_UN16*)lpInput, (RT_UN32*)lpOutputPayload, unInputCharSize);
          break;
        case RT_ENCODING_UTF_32BE:
          RtEncoding_Copy16LeTo32Be((RT_UN16*)lpInput, (RT_UN32*)lpOutputPayload, unInputCharSize);
          break;
      }
      break;
    case RT_ENCODING_UTF_16BE:
      switch (unOutputEncoding)
      {
        ...
        case RT_ENCODING_UTF_32:
        case RT_ENCODING_UTF_32LE:
          RtEncoding_Copy16BeTo32Le((RT_UN16*)lpInput, (RT_UN32*)lpOutputPayload, unInputCharSize);
          break;
        case RT_ENCODING_UTF_32BE:
          RtEncoding_Copy16BeTo32Be((RT_UN16*)lpInput, (RT_UN32*)lpOutputPayload, unInputCharSize);
          break;
      }
      break;
    case RT_ENCODING_UTF_32LE:
      switch (unOutputEncoding)
      {
        case RT_ENCODING_UTF_16:
        case RT_ENCODING_UTF_16LE:
          RtEncoding_Copy32LeTo16Le((RT_UN32*)lpInput, (RT_UN16*)lpOutputPayload, unInputCharSize);
          break;
        case RT_ENCODING_UTF_16BE:
          RtEncoding_Copy32LeTo16Be((RT_UN32*)lpInput, (RT_UN16*)lpOutputPayload, unInputCharSize);
          break;
        case RT_ENCODING_UTF_32:
        case RT_ENCODING_UTF_32LE:
          /* No transformation. */
        ...
        case RT_ENCODING_UTF_32BE:
          /* Swap 32. */
          RtMemory_SwapBytes32((RT_UN32*)lpInput, (RT_UN32*)lpOutputPayload, unInputCharSize);
          break;
      }
      break;
    case RT_ENCODING_UTF_32BE:
      switch (unOutputEncoding)
      {
        case RT_ENCODING_UTF_16:
        case RT_ENCODING_UTF_16LE:
          RtEncoding_Copy32BeTo16Le((RT_UN32*)lpInput, (RT_UN16*)lpOutputPayload, unInputCharSize);
          break;
        case RT_ENCODING_UTF_16BE:
          RtEncoding_Copy32BeTo16Be((RT_UN32*)lpInput, (RT_UN16*)lpOutputPayload, unInputCharSize);
          break;
        case RT_ENCODING_UTF_32:
        case RT_ENCODING_UTF_32LE:
          /* Swap 32. */
...
/**
 * Windows WideCharToMultiByte/MultiByteToWideChar does not manage UTF-16/UTF-32 conversions.<br>
 * This is done by this function that manage input BOM and call <tt>RtEncoding_EncodeOrDecodeUnicode</tt>.
 *
 * @return Output size in bytes.
 */
RT_UN RT_CALL RtEncoding_EncodeOrDecodeUnicodeWithBom(RT_CHAR8* lpInput, RT_UN unInputCharSize, RT_UN unInputEncoding, RT_CHAR8* lpBuffer, RT_UN unBufferSize, void** lpHeapBuffer, RT_UN* lpHeapBufferSize, RT_CHAR8** lpOutput, RT_HEAP** lpHeap, RT_UN unOutputEncoding, RT_UN unInputTerminatingZeroSize, RT_UN unOutputTerminatingZeroSize)
{
  ...
  unResult = RtEncoding_EncodeOrDecodeUnicode(lpInputPayload, unInputPayloadSize, unInputPayloadEncoding, lpBuffer, unBufferSize, lpHeapBuffer, lpHeapBufferSize, lpOutput, lpHeap, unOutputEncoding, unInputTerminatingZeroSize, unOutputTerminatingZeroSize);
 ...
 */
RT_UN RT_CALL RtEncoding_PerformIconvWithHeap(iconv_t lpIconv, RT_CHAR8* lpInput, RT_UN unInputSize, RT_UN unInitialHeapBufferSize, void** lpHeapBuffer, RT_UN* lpHeapBufferSize, RT_CHAR8** lpOutput, RT_HEAP** lpHeap, RT_UN unOutputTerminatingZeroSize)
{
  RT_CHAR8* lpIconvInput;
  RT_CHAR8* lpIconvBuffer;
 ...
 */
RT_UN RT_CALL RtEncoding_IconvWithIconv(iconv_t lpIconv, RT_CHAR8* lpInput, RT_UN unInputSize, RT_CHAR8* lpBuffer, RT_UN unBufferSize, void** lpHeapBuffer, RT_UN* lpHeapBufferSize, RT_CHAR8** lpOutput, RT_HEAP** lpHeap, RT_UN unInputTerminatingZeroSize, RT_UN unOutputTerminatingZeroSize)
{
  RT_B bUseHeap;
  RT_UN unHeapBufferSize;
  size_t nIconvInputSize;
  ...
  if (lpBuffer)
  {
    unResult = RtEncoding_PerformIconvWithBuffer(lpIconv, lpInput, unInputSize, lpBuffer, unBufferSize, unOutputTerminatingZeroSize);
 ...
 * @return The written bytes count in <tt>lpBuffer</tt>, not including the terminating zero bytes.
 */
RT_UN RT_CALL RtEncoding_IconvWithEncoding(RT_CHAR* lpInputEncoding, RT_CHAR* lpOutputEncoding, RT_CHAR8* lpInput, RT_UN unInputSize, RT_CHAR8* lpBuffer, RT_UN unBufferSize, void** lpHeapBuffer, RT_UN* lpHeapBufferSize, RT_CHAR8** lpOutput, RT_HEAP** lpHeap, RT_UN unInputTerminatingZeroSize, RT_UN unOutputTerminatingZeroSize)
{
  RT_B bOpen;
  ...
  if (unInputSize == RT_TYPE_MAX_UN)
  {
    unActualInputSize = RtEncoding_GetDataSize(lpInput, unInputTerminatingZeroSize);
  }
  else
  {
  ...
  unResult = RtEncoding_IconvWithIconv(lpIconv, lpInput, unActualInputSize, lpBuffer, unBufferSize, lpHeapBuffer, lpHeapBufferSize, lpOutput, lpHeap, unInputTerminatingZeroSize, unOutputTerminatingZeroSize);
...
RT_CHAR* RT_CALL RtEncoding_GetLinuxSystemEncoding()
{
  ...
  if (RtFastInitialization_IsRequired(&rt_encodingSystemInitialization))
  {
    ...
    RtFastInitialization_NotifyDone(&rt_encodingSystemInitialization);
  }
 ...
 */
RT_UN RT_CALL RtEncoding_EncodeOrDecode(RT_CHAR8* lpInput, RT_UN unInputSize, RT_UN unEncoding, RT_CHAR8* lpBuffer, RT_UN unBufferSize, void** lpHeapBuffer, RT_UN* lpHeapBufferSize, RT_CHAR8** lpOutput, RT_HEAP** lpHeap, RT_B bEncode)
{
  ...
  lpSystemEncoding = RtEncoding_GetLinuxSystemEncoding();
  ...
  if (bEncode)
  {
    ...
    unOutputTerminatingZeroSize = RtEncoding_GetTerminatingZeroSize(unEncoding);
  ...
  else
  {
    ...
    unInputTerminatingZeroSize = RtEncoding_GetTerminatingZeroSize(unEncoding);
      ...
      (unEncoding == RT_ENCODING_UTF_32BE))
  {
    ...
    {
      /* The RtEncoding_GetDataSize return size in bytes. */
      unInputCharSize = RtEncoding_GetDataSize(lpInput, unInputTerminatingZeroSize) / unInputTerminatingZeroSize;
    }
    unResult = RtEncoding_EncodeOrDecodeUnicodeWithBom(lpInput, unInputCharSize, unInputEncoding, lpBuffer, unBufferSize, lpHeapBuffer, lpHeapBufferSize, lpOutput, lpHeap, unOutputEncoding, unInputTerminatingZeroSize, unOutputTerminatingZeroSize);
  ...
  {
    unResult = RtEncoding_EncodeOrDecodeUsingWindows(lpInput, unInputSize, unEncoding, lpBuffer, unBufferSize, lpHeapBuffer, lpHeapBufferSize, lpOutput, lpHeap, bEncode, unOutputTerminatingZeroSize);
  }
#else /* NOT RT_DEFINE_WINDOWS */

  unResult = RtEncoding_IconvWithEncoding(lpInputEncoding, lpOutputEncoding, lpInput, unInputSize, lpBuffer, unBufferSize, lpHeapBuffer, lpHeapBufferSize, lpOutput, lpHeap, unInputTerminatingZeroSize, unOutputTerminatingZeroSize);
#endif
free_resources:
  return unResult;
...
RT_UN RT_API RtEncoding_DecodeWithHeap(RT_CHAR8* lpInput, RT_UN unInputSize, RT_UN unEncoding, RT_CHAR** lpOutput, RT_HEAP** lpHeap)
{
  void* lpHeapBuffer;
  RT_UN unHeapBufferSize;
  ...
  unHeapBufferSize = 0;
  return RtEncoding_Decode(lpInput, unInputSize, unEncoding, RT_NULL, 0, &lpHeapBuffer, &unHeapBufferSize, lpOutput, lpHeap);
}

RT_UN RT_API RtEncoding_Decode(RT_CHAR8* lpInput, RT_UN unInputSize, RT_UN unEncoding, RT_CHAR* lpBuffer, RT_UN unBufferSize, void** lpHeapBuffer, RT_UN* lpHeapBufferSize, RT_CHAR** lpOutput, RT_HEAP** lpHeap)
{
  return RtEncoding_EncodeOrDecode(lpInput, unInputSize, unEncoding, (RT_CHAR8*)lpBuffer, unBufferSize, lpHeapBuffer, lpHeapBufferSize, (RT_CHAR8**)lpOutput, lpHeap, RT_FALSE);
}

RT_UN RT_API RtEncoding_EncodeWithHeap(RT_CHAR* lpInput, RT_UN unInputSize, RT_UN unEncoding, RT_CHAR8** lpOutput, RT_HEAP** lpHeap)
{
  void* lpHeapBuffer;
  RT_UN unHeapBufferSize;
  ...
  lpHeapBuffer = RT_NULL;
  unHeapBufferSize = 0;
  return RtEncoding_Encode(lpInput, unInputSize, unEncoding, RT_NULL, 0, &lpHeapBuffer, &unHeapBufferSize, lpOutput, lpHeap);
}

RT_UN RT_API RtEncoding_Encode(RT_CHAR* lpInput, RT_UN unInputSize, RT_UN unEncoding, RT_CHAR8* lpBuffer, RT_UN unBufferSize, void** lpHeapBuffer, RT_UN* lpHeapBufferSize, RT_CHAR8** lpOutput, RT_HEAP** lpHeap)
{
  return RtEncoding_EncodeOrDecode((RT_CHAR8*)lpInput, unInputSize, unEncoding, lpBuffer, unBufferSize, lpHeapBuffer, lpHeapBufferSize, lpOutput, lpHeap, RT_TRUE);
}

RT_UN RT_API RtEncoding_DecodeWithBuffer(RT_CHAR8* lpInput, RT_UN unInputSize, RT_UN unEncoding, RT_CHAR* lpBuffer, RT_UN unBufferSize)
{
  RT_CHAR* lpOutput;
  return RtEncoding_Decode(lpInput, unInputSize, unEncoding, lpBuffer, unBufferSize, RT_NULL, RT_NULL, &lpOutput, RT_NULL);
}

RT_UN RT_API RtEncoding_EncodeWithBuffer(RT_CHAR* lpInput, RT_UN unInputSize, RT_UN unEncoding, RT_CHAR8* lpBuffer, RT_UN unBufferSize)
{
  RT_CHAR8* lpOutput;
  return RtEncoding_Encode(lpInput, unInputSize, unEncoding, lpBuffer, unBufferSize, RT_NULL, RT_NULL, &lpOutput, RT_NULL);
}

RT_UN RT_API RtEncoding_GetTerminatingZeroSize(RT_UN unEncoding)
{
  RT_UN unResult;
...
RT_UN RT_API RtEncoding_GetDataSize(RT_CHAR8* lpData, RT_UN unTerminatingZeroSize)
{
  RT_CHAR8* lpChars;
  RT_UN16* lpWideChars;
